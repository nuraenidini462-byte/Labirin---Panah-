...
// FUNGSI DESAIN GAME CANVAS (DIJAMIN TANPA ERROR / BLANK)
function draw() {
    ...
    arrows.forEach(a => {
        ...
        // 2. Gambar Kepala Panah Segitiga Menempel Sempurna
